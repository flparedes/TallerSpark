...
public class DocumentService {
	 ...
	 * 
	 * @param fileName
	 *            Nombre del documento a insertar.
	 * @param is
	 *            InputStream con el contenido del fichero a insertar.
	 * @param userName
	 *            Nombre del usuario que realiza la subida.
	 * @return Resultado de la inserción.
	 * @throws IOException
	 *             Excepción en caso de que falle la lectura del contenido.
	 */
	 ...
	 *            Nombre del documento a insertar.
	 * @param type
	 *            Tipo mime del documento a insertar.
	 * @param is
	 *            InputStream con el contenido del fichero a insertar.
	 * @param userName
	 *            Nombre del usuario que realiza la subida.
	...
	/**
	 * Borra el documento en la Base de Datos. Para borrar el documento este
	 * tiene que existir y pertenecer al usuario dado.
	 * 
	 * @param documento
	 *            Documento que se desea borrar.
	 * @param user
	 *            Usuario que lanza el borrado.
	 * @return Resultado del borrado.
	 * @throws IOException
	 *             Excepción en caso de que falle el borrado del contenido.
	 */
	public boolean delete(Document documento, User user) throws IOException {
		boolean deleted = false;
		if (documento != null && user != null) {
			if (user.equals(documento.getUser())) {
				deleted = documentDao.delete(documento);
			}
		}
